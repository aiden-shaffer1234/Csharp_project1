...
namespace Library.eCommerce.Services
{
    public class ProductServiceProxy
    {
        ...
        private ProductServiceProxy( ) {
            ...
            {
                new Item{ Product = new ProductDTO{Id = 1, Name ="Product 1"}, Id = 1, Quantity = 10},
                new Item{ Product = new ProductDTO{Id = 2, Name ="Product 2"}, Id = 2, Quantity = 20},
                new Item{ Product = new ProductDTO{Id = 3, Name ="Product 3"}, Id = 3, Quantity = 30}
            };
        }
